...
public class OrderServiceImplTest {
    ...
    void setUp() throws Exception {
        Listing listing1 = new Listing("Celana Denim", "tukang_baju", 10, 100_000L);
        Listing listing2 = new Listing("Kaos", "tukang_baju", 10, 35_000L);
        Listing listing3 = new Listing("Kerudung", "unikgue", 40, 155_000L);
        Listing listing4 = new Listing("Gamis Shimmer", "unikgue", 33, 200_000L);
    ...
    void whenSetStatusOrderByUnauthorizedSeller_thenThrowForbiddenException() {
        ...
        assertThrows(ForbiddenException.class,
                     () -> orderService.updateOrderStatus(order.getId(), OrderStatus.DIPROSES.name(), "hacker"));
        verify(orderRepository, times(0)).save(any(Order.class));
    }
}
